...
#define HAVE_INC_FASTAPPROX_H 1

/* Define to 1 if you have the file `AC_File'. */
#define HAVE_INC_FASTBITSET_H 1

/* Define to 1 if you have the file `AC_File'. */
#define HAVE_INC_FASTMATH_H 1

/* Define to 1 if you have the file `AC_File'. */
#define HAVE_INC_FASTNUMINT_H 1

/* Define to 1 if you have the file `AC_File'. */
#define HAVE_INC_STOPWATCH_H 1
...
/* Define to 1 if you have the file `AC_File'. */
#define HAVE_SRC_FASTMATH_CPP 1

/* Define to 1 if you have the file `AC_File'. */
#define HAVE_SRC_FASTNUMINT_CPP 1

/* Define to 1 if you have the file `AC_File'. */
#define HAVE_SRC_STOPWATCH_CPP 1
...
/* Name of package */
#define PACKAGE "fastmath"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "w.cunningham@northeastern.edu"

/* Define to the full name of this package. */
#define PACKAGE_NAME "FastMath"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "FastMath 1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fastmath"
